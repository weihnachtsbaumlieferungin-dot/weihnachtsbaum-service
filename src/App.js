...
import { Truck, Home, CheckCircle, MapPin, Phone, Mail, Star } from 'lucide-react';
...
export default function ChristmasTreeService() {
  ...
  const calculateTotal = () => {
    const packagePrice = packages.find(p => p.id === formData.package)?.price || 0;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-red-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Bestellung versendet!</h2>
          <p className="text-gray-700 mb-6">
            Vielen Dank für Ihre Bestellung! Wir haben Ihre Anfrage erhalten und melden uns in Kürze bei Ihnen.
          </p>
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-gray-800 font-semibold mb-2">💳 Zahlungshinweis</p>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="text-gray-600 text-sm">
              Bei Fragen erreichen Sie uns unter: weihnachtsbaumlieferungIN@gmail.com
            </p>
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-green-600 font-semibold hover:text-green-700">
              {CONTACT_EMAIL}
            </a>
          </div>
          <button
            onClick={() => {
              ...
              setFormData({
                name: '', email: '', phone: '', address: '', treeSize: '',
                package: 'basis', disposal: false, notes: ''
              });
            }}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-red-50 py-12 px-4">
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Baum bestellen</h2>
          ...
          <form action={`https://formspree.io/f/${FORMSPREE_ID}`} method="POST" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="phone" className="block text-gray-700 font-semibold mb-2">Telefon *</label>
                <input
                  type="tel"
                  id="phone"
                  name="phone"
            ...
            <div>
              <label htmlFor="address" className="block text-gray-700 font-semibold mb-2">Lieferadresse *</label>
              <input
                type="text"
                id="address"
                name="address"
            ...
            <div>
              <label htmlFor="treeSize" className="block text-gray-700 font-semibold mb-2">Baumgröße *</label>
              <select
                id="treeSize"
                name="treeSize"
                required
                value={formData.treeSize}
                onChange={(e) => setFormData({...formData, treeSize: e.target.value})}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
              >
            ...
            <div>
              <label className="block text-gray-700 font-semibold mb-3">Service-Paket *</label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {packages.map((pkg) => (
                  <label
                    key={pkg.id}
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, package: pkg.id})}
                      className="sr-only"
                    />
                    {pkg.popular && (
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => setFormData({...formData, disposal: e.target.checked})}
            ...
            <div>
              <label htmlFor="notes" className="block text-gray-700 font-semibold mb-2">Besondere Wünsche</label>
              <textarea
                id="notes"
                name="notes"
            ...
            <div className="bg-green-50 rounded-lg p-4 border-2 border-green-200">
              <div className="flex justify-between items-center mb-2">
                <span className="text-gray-700 font-semibold">Service-Gesamtpreis:</span>
                <span className="text-2xl font-bold text-green-600">{calculateTotal()}€</span>
              </div>
              <p className="text-xs text-gray-600">+ Baumpreis (wird nach Auswahl mitgeteilt)</p>
              <p className="text-xs text-gray-600 mt-2 font-semibold">💳 Bezahlung in bar bei Lieferung</p>
            </div>
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-32">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold mb-6">
              Weihnachtsbaum-Service<br/>Ingolstadt
            </h1>
            <p className="text-xl sm:text-2xl mb-8 text-green-100 max-w-2xl mx-auto">
              Wir bringen Ihnen den perfekten Weihnachtsbaum – direkt bis zur Haustür
            </p>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">Wir wählen Ihren Baum persönlich nach Ihren Wünschen aus und senden Ihnen vorab ein Foto</p>
          </div>
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">Wir liefern direkt zu Ihnen nach Hause – auf Wunsch tragen wir auch hoch</p>
          </div>
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">Optional stellen wir Ihren Baum professionell auf und entsorgen ihn nach Weihnachten</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">Unsere Premium-Bäume</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              'https://images.unsplash.com/photo-1576870734744-408a8075bc83?w=800',
              'https://images.unsplash.com/photo-1544279904-c13c9b39fc3a?w=800',
              ...
              <div key={idx} className="relative overflow-hidden rounded-2xl shadow-lg group cursor-pointer">
                <img
                  src={src}
                  alt={`Weihnachtsbaum ${idx + 1}`}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition flex items-end p-4">
                  <p className="text-white font-semibold">Premium Nordmanntanne</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Packages */}
      <div className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">Unsere Service-Pakete</h2>
        <p className="text-center text-gray-600 mb-12">Wählen Sie das passende Paket für Ihre Bedürfnisse</p>
        ...
        <div className="mt-8 p-6 bg-yellow-50 rounded-xl border-2 border-yellow-200 max-w-4xl mx-auto">
          ...
          <p className="text-gray-700">
            <strong>Abholung & fachgerechte Entsorgung</strong> nach Weihnachten: <span className="text-2xl font-bold text-green-600">40€</span>
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-green-100">
            Bestellen Sie jetzt und lehnen Sie sich zurück – wir übernehmen den Rest!
          </p>
          <button
            onClick={() => setShowOrderForm(true)}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-6">Kontakt & Service-Gebiet</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  <MapPin className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                  <div>
                    <p className="font-semibold">Service-Gebiet</p>
                    <p className="text-gray-600">Ingolstadt + Umgebung (10-20 km)</p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${CONTACT_EMAIL}`} className="text-green-600 hover:text-green-700">
                      {CONTACT_EMAIL}
                    </a>
                  </div>
                </div>
            ...
            <div>
              ...
              <ol className="space-y-4">
                <li className="flex items-start">
                  <div className="bg-green-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3 flex-shrink-0">1</div>
                  <div>
                    <p className="font-semibold">Bestellung aufgeben</p>
                    <p className="text-gray-600 text-sm">Teilen Sie uns Ihre Wünsche mit</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-green-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3 flex-shrink-0">2</div>
                  <div>
                    <p className="font-semibold">Foto-Vorschau</p>
                    <p className="text-gray-600 text-sm">Sie erhalten ein Foto Ihres Baumes</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-green-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3 flex-shrink-0">3</div>
                  <div>
                    <p className="font-semibold">Lieferung & Barzahlung</p>
                    <p className="text-gray-600 text-sm">Wir liefern zum Wunschtermin, Sie zahlen bar</p>
                  </div>
                </li>
              </ol>
            </div>
